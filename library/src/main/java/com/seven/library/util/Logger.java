...
public class Logger {
    ...
    public static void init(boolean logSwitch, boolean log2FileSwitch, char logFilter, String tag) {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = BasicApplication.getInstance().getExternalCacheDir().getPath() + File.separator;
        } else {
            dir = BasicApplication.getInstance().getCacheDir().getPath() + File.separator;
        }
    ...
    public static Builder getBuilder() {
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
            dir = BasicApplication.getInstance().getExternalCacheDir().getPath() + File.separator + "log" + File.separator;
        } else {
            dir = BasicApplication.getInstance().getCacheDir().getPath() + File.separator + "log" + File.separator;
        }
        return new Builder();
    }
