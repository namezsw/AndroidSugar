 ...
 * 一个增强的BottomNavigationView的安卓库
 * Created by Seven on 2017/3/20.
 */
public class BottomNavigationEnView extends BottomNavigationView {
    // used for animation
    ...
    public BottomNavigationEnView(Context context) {
        super(context);
    }

    public BottomNavigationEnView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BottomNavigationEnView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
     ...
     * necessary calls back to the provided {@link BottomNavigationEnView} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BottomNavigationEnView> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(BottomNavigationEnView bnve) {
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavigationEnView bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
